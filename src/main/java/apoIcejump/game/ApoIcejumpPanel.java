	...
	public class ApoIcejumpPanel extends ApoIcejumpComponent {
		...
		public void makeBird(int count, boolean bNew) {
			if (bNew) {
				this.bird = new ArrayList<ApoIcejumpBird>();
			}
			for (int i = 0; i < count; i++) {
		...
		public void makeBlocks(long randomInt) {
	...
	//    	System.out.println(path+" "+classname+" "+classN);
		...
		public void thinkBird(int delta) {
		...
		public void thinkGoodies(int delta) {
		...
		public boolean thinkPlayers(int delta, boolean bTutorial) {
		...
		public void thinkBlocks(int delta) {
